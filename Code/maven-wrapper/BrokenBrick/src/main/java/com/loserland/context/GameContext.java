...
public class GameContext {
    ...
    public static String PAUSE_IMG = "game.background.music.pause.image";
    public static String PLAY_IMG = "game.background.music.play.image";
    public static String VOL_DOWN_IMG = "game.background.music.down.image";
    public static String VOL_UP_IMG = "game.background.music.up.image";
    public static String VOLUME = "game.background.music.vol";
